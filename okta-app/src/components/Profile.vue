  ...
  <div class="py-5 align-middle inline-block min-w-full sm:px-6 lg:px-8">
    <div class="shadow overflow-hidden border-b border-red-10 sm:rounded-lg">
      ...
      <div >
       ...
       <div  id = "div-table" class="w-full overflow-y-auto bg-gray-300" style="height:120px" >
          ...
          <table id= "balanceStock" class="w-full table-auto">
            ...
            <td style ="font-size:17px"  class="px-6 py-3 text-left text-xs font-large text-black-700 tracking-wider">{{stock.id_stock}} </td>
            <td style ="font-size:17px"  class="px-6 py-3 text-left text-xs font-large text-black-700 tracking-wider">{{stock.stock_symbol}}
            <span style="font-size:12px; color:gray">{{stock.stock_name}}</span>
            </td>
            <td style ="font-size:17px" class="px-6 py-3 text-left text-xs font-large text-black-700 tracking-wider">{{stock.volume}} un.</td>
            </tr>
            </thead>  
          </table>
      </div>
          ...
          <table id= "userOrders" class="w-full table-auto">
            <thead class="bg-gray-300 py-5" > 
              <tr v-for="stock in filteredOrders" :key="stock.stock_id">
                ...
                <td style ="font-size:12px" class="px-6 py-3 text-right text-xs font-large text-black-700 tracking-wider">{{stock.created_on}} un.</td>
                <td style ="font-size:17px" class="px-6 py-3 text-right text-xs font-large text-black-700 tracking-wider">{{stock.volume}} un.</td>
                <td style ="font-size:17px" class="px-6 py-3 text-right text-xs font-large text-black-700 tracking-wider">U${{stock.price}}</td>
                <td style ="font-size:12px" class="px-6 py-3 text-right text-xs font-large text-black-700 tracking-wider">{{stock.updated_on}} un.</td>
                <td style ="font-size:17px" class="px-6 py-3 text-right text-xs font-large text-black-700 tracking-wider">{{stock.remaing_volume}} un.</td>
              </tr>
            </thead>  
          </table>
      </div>
